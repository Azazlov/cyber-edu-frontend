(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,42141,e=>{"use strict";var t=e.i(43476);e.s(["LessonContent",0,({content:e})=>{let s=e.split("\n"),i=[],n=!1,a=[],r=!1,l=[],o=()=>{r&&l.length>0&&(i.push((0,t.jsx)("ul",{className:"list-disc list-inside space-y-2 my-4 text-gray-700",children:l},`list-${i.length}`)),l=[],r=!1)},c=e=>e.includes("**")?e.split(/\*\*(.+?)\*\*/).map((e,s)=>s%2==1?(0,t.jsx)("strong",{className:"text-gray-900",children:e},s):e):e;return s.forEach((e,s)=>{if(e.startsWith("```"))return void(n?(i.push((0,t.jsx)("pre",{className:"bg-gray-900 text-green-400 p-4 rounded-lg overflow-x-auto my-4 font-mono text-sm",children:(0,t.jsx)("code",{children:a.join("\n")})},`code-${s}`)),a=[],n=!1):(o(),n=!0));if(n)return void a.push(e);if(e.startsWith("# ")){o(),i.push((0,t.jsx)("h1",{className:"text-3xl font-bold text-gray-800 mt-8 mb-4",children:e.replace("# ","")},`h1-${s}`));return}if(e.startsWith("## ")){o(),i.push((0,t.jsx)("h2",{className:"text-2xl font-bold text-gray-800 mt-6 mb-3",children:e.replace("## ","")},`h2-${s}`));return}if(e.startsWith("### ")){o(),i.push((0,t.jsx)("h3",{className:"text-xl font-bold text-gray-800 mt-4 mb-2",children:e.replace("### ","")},`h3-${s}`));return}if(""===e.trim())return void o();if(e.startsWith("- ")){r=!0;let i=e.substring(2),n=i.match(/^(\p{Emoji})\s*\*\*(.+?)\*\*\s*(.*)?$/u);if(n){let[,e,i,a]=n;l.push((0,t.jsxs)("li",{className:"ml-2",children:[(0,t.jsx)("span",{className:"mr-2",children:e}),(0,t.jsx)("strong",{className:"text-gray-900",children:i}),a&&(0,t.jsxs)("span",{className:"text-gray-700",children:[" ",a]})]},`item-${s}`));return}if(/^\p{Emoji}/u.test(i)){let e=Array.from(i)[0],n=i.substring(e.length).trim();l.push((0,t.jsxs)("li",{className:"ml-2",children:[(0,t.jsx)("span",{className:"mr-2",children:e}),(0,t.jsx)("span",{children:c(n)})]},`item-${s}`));return}let a=i.match(/^\*\*(.+?)\*\*\s*[—-]\s*(.+)$/);if(a){let[,e,i]=a;l.push((0,t.jsxs)("li",{className:"ml-2",children:[(0,t.jsx)("strong",{className:"text-gray-900",children:e}),(0,t.jsxs)("span",{className:"text-gray-700",children:[" — ",i]})]},`item-${s}`));return}return i.startsWith("**")?void l.push((0,t.jsx)("li",{className:"ml-2",children:c(i)},`item-${s}`)):void l.push((0,t.jsx)("li",{className:"ml-2",children:c(i)},`item-${s}`))}o(),i.push((0,t.jsx)("p",{className:"text-gray-700 my-2 leading-relaxed",children:c(e)},`p-${s}`))}),o(),(0,t.jsx)("div",{className:"prose prose-lg max-w-none",children:i})}])},88653,e=>{"use strict";e.i(47167);var t=e.i(43476),s=e.i(71645),i=e.i(31178),n=e.i(47414),a=e.i(74008),r=e.i(21476),l=e.i(72846),o=s,c=e.i(37806);function d(e,t){if("function"==typeof e)return e(t);null!=e&&(e.current=t)}class m extends o.Component{getSnapshotBeforeUpdate(e){let t=this.props.childRef.current;if(t&&e.isPresent&&!this.props.isPresent&&!1!==this.props.pop){let e=t.offsetParent,s=(0,l.isHTMLElement)(e)&&e.offsetWidth||0,i=(0,l.isHTMLElement)(e)&&e.offsetHeight||0,n=this.props.sizeRef.current;n.height=t.offsetHeight||0,n.width=t.offsetWidth||0,n.top=t.offsetTop,n.left=t.offsetLeft,n.right=s-n.width-n.left,n.bottom=i-n.height-n.top}return null}componentDidUpdate(){}render(){return this.props.children}}function x({children:e,isPresent:i,anchorX:n,anchorY:a,root:r,pop:l}){let x=(0,o.useId)(),p=(0,o.useRef)(null),h=(0,o.useRef)({width:0,height:0,top:0,left:0,right:0,bottom:0}),{nonce:u}=(0,o.useContext)(c.MotionConfigContext),g=function(...e){return s.useCallback(function(...e){return t=>{let s=!1,i=e.map(e=>{let i=d(e,t);return s||"function"!=typeof i||(s=!0),i});if(s)return()=>{for(let t=0;t<i.length;t++){let s=i[t];"function"==typeof s?s():d(e[t],null)}}}}(...e),e)}(p,e.props?.ref??e?.ref);return(0,o.useInsertionEffect)(()=>{let{width:e,height:t,top:s,left:o,right:c,bottom:d}=h.current;if(i||!1===l||!p.current||!e||!t)return;let m="left"===n?`left: ${o}`:`right: ${c}`,g="bottom"===a?`bottom: ${d}`:`top: ${s}`;p.current.dataset.motionPopId=x;let f=document.createElement("style");u&&(f.nonce=u);let j=r??document.head;return j.appendChild(f),f.sheet&&f.sheet.insertRule(`
